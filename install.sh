...
UNAME_O="$(uname -o 2>/dev/null || echo "")"
HAS_TERMUX_INFO=false
command -v termux-info >/dev/null 2>&1 && HAS_TERMUX_INFO=true
if [ "$UNAME_O" = "Android" ] || [ "$HAS_TERMUX_INFO" = true ]; then
